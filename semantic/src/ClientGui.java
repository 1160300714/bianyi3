...
//		scrollpane_lex_result.setBounds(350, 40, 360, 200);
		
		lb_lex_error = new JLabel("推导过程");
		main_panel.add(lb_lex_error);
//		lb_lex_error.setBounds(10, 260, 80, 20);
...
//		scrollpane_lex_error.setBounds(10, 300, 600, 300);
		...
		scrollpane_symbol_list.setBounds(330, 40, 360, 200);
		

		
		lb_triples = new JLabel("三地址指令");
		main_panel.add(lb_triples);
		lb_triples.setBounds(10,270, 80, 20);
		
		tbmodel_triples = new DefaultTableModel(null, new String[]{"序号","三地址码","四元式序列"});
		...
		scrollpane_triples.setBounds(10, 300, 680, 300);
